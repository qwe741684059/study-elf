...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public RedisTemplate<Object, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        ParserConfig.getGlobalInstance().addAccept("stu.cmq.domain");
        ParserConfig.getGlobalInstance().addAccept("stu.cmq.domain.vo");
        // 模块内的实体类
        ParserConfig.getGlobalInstance().addAccept("stu.cmq.service.dto");
